...
import myResume from "../assets/Photo.pdf";
...
const linkedin = "https://www.linkedin.com/in/elvis-alexander-332a60332";
const github = "https://github.com/xanderkings";
          ...
          <div className="content">
            <div className="hero-main">
              <div className="hero-text">
                <h1>Wellspring Computer Scientist</h1>
                <img src={waveHand} alt="waving_hand" className="shaking-hand" />
                <p>Hi, Im Omeire Alexander. A Wellspring Computer Scientist based in Benin, Nigeria NG. 📍</p>
                <span>
                  ...
                  <button className="btn btn-color-2 bg-#000ff hover" onClick={openPdfInNewTab}>
                    Download Resume
                  </button>
